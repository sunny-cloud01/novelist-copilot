...
from app.core.phase_two_adapter import WORKSPACE_ID, apply_story_bible_action, create_novel_project, get_novel_project, get_story_bible, list_novel_projects
